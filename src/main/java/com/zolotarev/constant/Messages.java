package com.zolotarev.constant;

/**
 * Contains message codes for i18n support
...
public final class Messages {
    ...
    public static final String AMOUNT_MUST_BE_POSITIVE = "amount_must_be_positive";
    public static final String AMOUNT_MUST_BE_NOT_NEGATIVE = "amount_must_be_not_negative";
    ...
    public static final String TARGET_ACCOUNT_ID_MUST_BE_NOT_NULL = "target_account_id_must_be_not_null";
    public static final String TOO_SMALL_AMOUNT_TO_DEPOSIT = "too_small_amount_to_deposit";
    public static final String TOO_SMALL_AMOUNT_TO_WITHDRAW = "too_small_amount_to_withdraw";
    public static final String TOO_SMALL_AMOUNT_TO_TRANSFER = "too_small_amount_to_transfer";
    public static final String TOO_HIGH_SCALE_OF_THE_AMOUNT = "too_high_scale_of_the_amount";
    public static final String NOT_ENOUGH_MONEY_TO_WITHDRAW = "not_enough_money_to_withdraw";
